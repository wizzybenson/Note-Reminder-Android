    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_reminder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int o = order;
                String c = color;
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(ModifyNoteActivity.this);
                String cookie = preferences.getString("reminderCookie", "");
                if (!"".equals(cookie)) {
                    retrofitApiInstance.change(cookie,IdNote, texte, e, o, c).enqueue(new Callback<ApiGenericPostResponse>() {
                        @Override
                        public void onResponse(Call<ApiGenericPostResponse> call, Response<ApiGenericPostResponse> response) {
                            ...
                            if (!(response.body() == null)) {
                                ...
                                if (apiResponse.getCode() == _SUCCESS_) {
                                    Toast.makeText(getBaseContext(), "Note modifié", Toast.LENGTH_LONG).show();
                                }
        ...
        echeance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(ModifyNoteActivity.this, date, myCalendar
